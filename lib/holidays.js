 ...
 *
 * So a weekday holiday must be billed entirely off-peak, and — the part that is easy to
 * get backwards — a 调休 weekend the State Council turns into a working day stays a
 * *weekend*, because the policy names 周末 as off-peak in full. This module therefore
 * only ever *adds* off-peak days; it never turns one into a working day. (The 调休
 * workdays are still recorded in `holidays-cn.json`, for audit.)
 *
